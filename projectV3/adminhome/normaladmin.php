...
<body background="../images/image/Bus-Traveling.jpg">
  ...
  <form class="" action="<?php echo  htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    <table width="500px" height="500px" bgcolor="#3C896D" align="center">
      ...
      <tr>
        <td align="center"><a href="../adminhome/addbus.php"><input type="button" name="busadd" value="Add Bus"></a> </td>
      </tr>
      <tr>
        <td align="center"><a href="../adminhome/showbus.php"><input type="button" name="showbus" value="Show Bus"></a></td>
      </tr>
      <tr>
        <td align="center"><a href="../adminhome/sellerinfo.php"><input type="button" name="sellerinfo" value="Seller Info"></a></td>
      </tr>
