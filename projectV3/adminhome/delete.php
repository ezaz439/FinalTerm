...
include_once("service.php");
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        if(isset($_POST['delete'])){
            ...
            $result2=removeUser2($_GET['id']);
            if($result){
                header("Location:../adminhome/showusers.php");
            }
        }
  ...
  ?>
   ...
   <form method="post">
     ...
     <tr>
      ...
      <tr>
         <td align="center" colspan="2"><input type="submit" name="delete" value="Delete"> &nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" name="back" value="Cancel"></a></td>
      </tr>
       </table>
     </form>
     <br>
