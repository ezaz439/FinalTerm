               ...
               if (mysqli_num_rows($result)>0) {
                 echo "Connected2";
                   while ($row=mysqli_fetch_array($result)) {
                       ...
                       if($q==0){
                         $sql="INSERT INTO signup(fullname,email,phonenumber,address,city) VALUES ('$name','$email','$phnnumber','$address1','$city')";
                         $sql2="INSERT INTO signin(email,password,status) VALUES ('$email','$password','0')";
                         echo "Connected3";
